...
topicC = Post.create(user: kevin, ptype: FOLDER_TYPE, title: "iPhone", body: "iPhone and iOS notes", private: false)
...
postC2 = Post.create(user: kevin, ptype: BLOG_TYPE, title: "Coffee Meets Bagel", body: "CMB is a really simple Dating App. It matches you with one new person a day. It uses your Facebook to try to match you with friends of friends.", private: false)
postA = Post.create(user: kevin, ptype: TWEET_TYPE, title: "Dropbox", body: "Automatically save every version of your files to the cloud.", private: false)
postA2 = Post.create(user: kevin, ptype: BLOG_TYPE, title: "Evernote", body: "Evernote sucks, but it's still the best note taking software available on computers today.", private: false)
postB = Post.create(user: kevin, ptype: LINK_TYPE, title: "Medium.com - well designed blogging platform", body: "http://www.medium.com", private: false)
postB2 = Post.create(user: kevin, ptype: LINK_TYPE, title: "GetWorkDoneMusic.com - Techno music. Better than Pandora for getting work done.", body: "http://www.GetWorkDoneMusic.com", private: false)
