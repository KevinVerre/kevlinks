...
postB = Post.create(ptype: LINK_TYPE, title: "Medium.com - well designed blogging platform", body: "http://www.medium.com")
postB2 = Post.create(ptype: LINK_TYPE, title: "GetWorkDoneMusic.com - Techno music. Better than Pandora for getting work done.", body: "http://www.GetWorkDoneMusic.com")
